# Web Development Project 4 - *Pick-a-Purr*

Submitted by: **Justin Chen**

This web app: **allows users to find new cat breeds with pictures and other data, with the ability to filter out certain traits.**
